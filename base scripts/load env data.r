...
env.nam <- c("depth", "slope","mass_concentration_of_chlorophyll_in_sea_water", "distance", "distance", "distance", "temperature", "ocean_mixed_layer_thickness", "nitrate", "nitrate", "nitrate", "nitrate", "nitrate", "nitrate", "nitrate", "nitrate", "oxygen", "oxygen", "oxygen", "oxygen", "oxygen", "oxygen", "oxygen", "oxygen", "salinity", "salinity", "salinity", "salinity", "salinity", "salinity", "salinity", "salinity", "silicate", "silicate", "silicate", "silicate", "silicate", "silicate", "silicate", "silicate", "temperature", "temperature", "temperature", "temperature", "temperature", "temperature", "temperature", "temperature", "sea_ice", "sea_surface_temperature","distance")
